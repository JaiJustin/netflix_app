...
mixin _$HomeState {
  ...
  List<HotAndNewData> get trendingMovieList =>
      throw _privateConstructorUsedError;
  List<HotAndNewData> get teensDramasMovieList =>
      throw _privateConstructorUsedError;
  List<HotAndNewData> get southIndianMovieList =>
      throw _privateConstructorUsedError;
  List<HotAndNewData> get trendingMovieAndTvList =>
      throw _privateConstructorUsedError;
...
abstract class $HomeStateCopyWith<$Res> {
  ...
  $Res call(
      ...
      List<HotAndNewData> teensDramasMovieList,
      List<HotAndNewData> southIndianMovieList,
      List<HotAndNewData> trendingMovieAndTvList,
      bool isLoading,
      bool hasError});
}
...
class _$HomeStateCopyWithImpl<$Res> implements $HomeStateCopyWith<$Res> {
  ...
  $Res call({
    ...
    Object? teensDramasMovieList = freezed,
    Object? southIndianMovieList = freezed,
    Object? trendingMovieAndTvList = freezed,
    ...
    return _then(_value.copyWith(
      ...
      trendingMovieList: trendingMovieList == freezed
          ...
          : trendingMovieList // ignore: cast_nullable_to_non_nullable
              as List<HotAndNewData>,
      teensDramasMovieList: teensDramasMovieList == freezed
          ? _value.teensDramasMovieList
          : teensDramasMovieList // ignore: cast_nullable_to_non_nullable
              as List<HotAndNewData>,
      southIndianMovieList: southIndianMovieList == freezed
          ...
          : southIndianMovieList // ignore: cast_nullable_to_non_nullable
              as List<HotAndNewData>,
      trendingMovieAndTvList: trendingMovieAndTvList == freezed
          ? _value.trendingMovieAndTvList
          : trendingMovieAndTvList // ignore: cast_nullable_to_non_nullable
              as List<HotAndNewData>,
    ...
    return _then(_$_Initial(
      ...
      southIndianMovieList: southIndianMovieList == freezed
          ...
          : southIndianMovieList // ignore: cast_nullable_to_non_nullable
              as List<HotAndNewData>,
      trendingMovieAndTvList: trendingMovieAndTvList == freezed
          ? _value._trendingMovieAndTvList
          : trendingMovieAndTvList // ignore: cast_nullable_to_non_nullable
              as List<HotAndNewData>,
      isLoading: isLoading == freezed
          ? _value.isLoading
...
class _$_Initial implements _Initial {
  const _$_Initial(
      ...
      required final List<HotAndNewData> teensDramasMovieList,
      required final List<HotAndNewData> southIndianMovieList,
      required final List<HotAndNewData> trendingMovieAndTvList,
      required this.isLoading,
      required this.hasError})
      : _pastYearMovieList = pastYearMovieList,
        _trendingMovieList = trendingMovieList,
        _teensDramasMovieList = teensDramasMovieList,
        _southIndianMovieList = southIndianMovieList,
        _trendingMovieAndTvList = trendingMovieAndTvList;
  ...
  final List<HotAndNewData> _teensDramasMovieList;
  @override
  List<HotAndNewData> get teensDramasMovieList {
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_teensDramasMovieList);
  }
  ...
  final List<HotAndNewData> _trendingMovieAndTvList;
  @override
  List<HotAndNewData> get trendingMovieAndTvList {
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_trendingMovieAndTvList);
  }
  ...
  @override
  String toString() {
    return 'HomeState(stateId: $stateId, pastYearMovieList: $pastYearMovieList, trendingMovieList: $trendingMovieList, teensDramasMovieList: $teensDramasMovieList, southIndianMovieList: $southIndianMovieList, trendingMovieAndTvList: $trendingMovieAndTvList, isLoading: $isLoading, hasError: $hasError)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._teensDramasMovieList, _teensDramasMovieList) &&
            const DeepCollectionEquality()
                .equals(other._southIndianMovieList, _southIndianMovieList) &&
            const DeepCollectionEquality().equals(
                other._trendingMovieAndTvList, _trendingMovieAndTvList) &&
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(_teensDramasMovieList),
      const DeepCollectionEquality().hash(_southIndianMovieList),
      const DeepCollectionEquality().hash(_trendingMovieAndTvList),
